...
public class NegoServerRunner {
	...
	/**
	 * If set to true the ProtocolManager will only confirm proposals if they are
	 * consistent with all proposals that have been confirmed earlier.
	 */
	...
	/**
	 * This method must be call at the start of every new game, before the players
	 * are started.
	 * 
	 * @param gameID
	 */
